...
development, linting and CI. It resided in https://github.com/turo/pre-commit-hooks before the migration.
...
```yaml
repos:
  - repo: https://github.com/open-turo/pre-commit-hooks
...
- [kennedy-whytech](https://github.com/kennedy-whytech) - Maintainer

## Changelog

For changes, see the
[Releases](https://github.com/open-turo/pre-commit-hooks/releases) documentation.
